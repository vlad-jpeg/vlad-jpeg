...
#### Had Experience in **mentoring**, coding, managing a small backend team like **Team Lead**. Rewriting monolithic applications from .NET Framework to .NET 5-6 versions to microservice architecture.
